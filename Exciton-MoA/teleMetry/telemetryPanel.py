...
class TelemetryPanel:
    ...
    def record_pair_scan(
        ...
        if entangler_control is not None:
            ...
            entry["entangler_nudge_msf_guard_enabled"] = bool(hint_gate.get("nudge_msf_guard_enabled", False))
            ...
            entry["entangler_nudge_msf_status"] = str(hint_gate.get("nudge_msf_status", "disabled"))
            entry["entangler_nudge_msf_sample_count"] = int(hint_gate.get("nudge_msf_sample_count", 0))
